...
class Plane {
    ...
    int age;
    int weight;
    Plane(String name, String color, int age, int weight) {
        this.name = name;
        this.color = color;
        this.age = age;
        this.weight = weight;
...
public class Main {
    ...
    public static void main(String[] args) {
        planes.add(new Plane("«Мрія»", "white",  34, 285000 ));
        planes.add(new Plane("Airbus 380", "yellow",  17, 276800 ));
        planes.add(new Plane("Ан-2", "green",  45, 3300 ));
